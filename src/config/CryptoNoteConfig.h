...
const uint64_t DIFFICULTY_TARGET                             = 1800; // 1800 seconds (30 mins)

const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = (uint32_t)(-1);
...
const uint64_t CRYPTONOTE_LOCKED_TX_ALLOWED_DELTA_BLOCKS     = 10; // wiggly ;)
...
const char     CRYPTONOTE_NAME[]                             = "Richonite";
...
const char     LATEST_VERSION_URL[]                          = "http://github.com/richonite/richonite/releases";
const std::string LICENSE_URL                                = "https://github.com/richonite/richonite/blob/master/LICENSE";
